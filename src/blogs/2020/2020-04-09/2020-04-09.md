...
The main takeaway is there are seven unique notes in a scale and each scale convey an emotion to the listeners. You should pick a scale based on the tonic and the seventh degree, because the seventh degree also known as the leading note should guide the listener back to tonic aka home!
